...
ENV OPENRA_RELEASE_VERSION=20210321
...
ADD bin/start.sh /usr/lib/openra/start.sh

RUN chown -R openra:openra /home/openra && chmod 755 /usr/lib/openra/start.sh
